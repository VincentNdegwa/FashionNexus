...
const Men = (props) => {
  ...
  useEffect(() => {
    const randomData = () => {
      const arr = [];
      for (let i = 0; i <= 9; i++) {
        const randomNumber = Math.floor(Math.random() * props?.maleData.length);
        let randomItem = props?.maleData[randomNumber];
  ...
  return (
    <div className="Essential">
      <div className="essential-holder">
        <div className="upper-item men-upper-item">
